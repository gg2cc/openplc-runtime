...
#define OD_CNT_RPDO 32
#define OD_CNT_TPDO 32
...
typedef struct {
    ...
    OD_RPDOCommunicationParameter_t x1400_RPDOCommunicationParameter;
    OD_RPDOCommunicationParameter_t x1401_RPDOCommunicationParameter;
    OD_RPDOCommunicationParameter_t x1402_RPDOCommunicationParameter;
    OD_RPDOCommunicationParameter_t x1403_RPDOCommunicationParameter;
    OD_RPDOCommunicationParameter_t x1404_RPDOCommunicationParameter[OD_CNT_RPDO - 4];
    OD_RPDOMappingParameter_t x1600_RPDOMappingParameter;
    OD_RPDOMappingParameter_t x1601_RPDOMappingParameter;
    OD_RPDOMappingParameter_t x1602_RPDOMappingParameter;
    OD_RPDOMappingParameter_t x1603_RPDOMappingParameter;
    OD_RPDOMappingParameter_t x1604_RPDOMappingParameter[OD_CNT_RPDO - 4];
    OD_TPDOCommunicationParameter_t x1800_TPDOCommunicationParameter;
    OD_TPDOCommunicationParameter_t x1801_TPDOCommunicationParameter;
    OD_TPDOCommunicationParameter_t x1802_TPDOCommunicationParameter;
    OD_TPDOCommunicationParameter_t x1803_TPDOCommunicationParameter;
    OD_TPDOCommunicationParameter_t x1804_TPDOCommunicationParameter[OD_CNT_TPDO - 4];
    OD_TPDOMappingParameter_t x1A00_TPDOMappingParameter;
    OD_TPDOMappingParameter_t x1A01_TPDOMappingParameter;
    OD_TPDOMappingParameter_t x1A02_TPDOMappingParameter;
    OD_TPDOMappingParameter_t x1A03_TPDOMappingParameter;
    OD_TPDOMappingParameter_t x1A04_TPDOMappingParameter[OD_CNT_TPDO - 4];
} OD_PERSIST_COMM_t;
...
#define OD_ENTRY_H1600 &OD->list[17 + OD_CNT_RPDO]
#define OD_ENTRY_H1800 &OD->list[17 + OD_CNT_RPDO + OD_CNT_RPDO]
#define OD_ENTRY_H1A00 &OD->list[17 + OD_CNT_RPDO + OD_CNT_RPDO + OD_CNT_TPDO]
...
#define OD_ENTRY_H1600_RPDOMappingParameter &OD->list[17 + OD_CNT_RPDO]
#define OD_ENTRY_H1800_TPDOCommunicationParameter &OD->list[17 + OD_CNT_RPDO + OD_CNT_RPDO]
#define OD_ENTRY_H1A00_TPDOMappingParameter &OD->list[17 + OD_CNT_RPDO + OD_CNT_RPDO + OD_CNT_TPDO]
