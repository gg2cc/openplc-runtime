...
typedef struct
{
    ...
    int iec_type;           /* Matching journal_buffer_type_t:
                             * 0=BOOL_INPUT, 1=BOOL_OUTPUT,
                             * 3=BYTE_INPUT, 4=BYTE_OUTPUT,
                             * 5=INT_INPUT,  6=INT_OUTPUT,
                             * 8=DINT_INPUT, 9=DINT_OUTPUT */
    int iec_index;          /* Index in IEC table */
    int iec_bit;            /* Bit index for BOOL type (0..7) */
} can_mapping_t;
